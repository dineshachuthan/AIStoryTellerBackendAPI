// Voice-style-orchestrator with external sounds JSON
import fs from 'fs';
...
async function processStoryForConversationStyle(filePath, narratorName, conversationType) {
  ...
  console.log(`✅ Saved with external sound expressions for ${conversationType} conversation with ${narratorName}.`);
}

// Example usage
// processStoryForConversationStyle('./articles/my_article.txt', 'FatherJohn', 'parent_to_child');
