// Restoring your complete Voice-style-orchestrator code with conversation style overlays
import fs from 'fs';
...
// processStoryForConversationStyle('./articles/my_article.txt', 'LittleTommy', 'child_to_parent');
// processStoryForConversationStyle('./articles/my_article.txt', 'YoungSisterLily', 'siblings');
