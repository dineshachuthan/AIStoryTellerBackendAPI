...
export const MESSAGE_TEMPLATES: Record<string, I18nMessageTemplate> = {
  ...
  VOICE_STATUS_LOCKED_TOOLTIP: {
    ...
    templates: {
      ...
      es: 'Usado para clonación de voz - bloqueado para edición',
      fr: 'Utilisé pour le clonage vocal - verrouillé en modification',
      de: 'Für Stimmklonen verwendet - für Bearbeitung gesperrt',
      ja: 'ボイスクローニングに使用 - 編集からロック',
      zh: '用于语音克隆 - 锁定编辑',
      ko: '음성 복제에 사용 - 편집에서 잠김'
    }
  },
  ...
  VOICE_STATUS_RECORDED_TOOLTIP: {
    ...
    templates: {
      ...
      es: 'Muestra grabada - disponible para clonación de voz',
      fr: 'Échantillon enregistré - disponible pour le clonage vocal',
      de: 'Probe aufgenommen - verfügbar für Stimmklonen',
      ja: 'サンプル録音済み - ボイスクローニング可能',
      zh: '样本已录制 - 可用于语音克隆',
      ko: '샘플 녹음됨 - 음성 복제 가능'
    }
  },
  ...
  VOICE_STATUS_EMPTY_TOOLTIP: {
    ...
    templates: {
      ...
      es: 'Aún no se ha grabado muestra',
      fr: 'Aucun échantillon enregistré encore',
  ...
  VOICE_BUTTON_PLAY_SAVED_TOOLTIP: {
    ...
    templates: {
      ...
      es: 'Reproducir grabación guardada',
      fr: 'Lire l\'enregistrement sauvegardé',
  ...
  VOICE_BUTTON_NO_RECORDING_TOOLTIP: {
    ...
    templates: {
      ...
      es: 'No hay grabación para reproducir',
      fr: 'Aucun enregistrement à lire',
  ...
  VOICE_EMOTION_READ_INSTRUCTION: {
    ...
    variables: ['emotion'],
    templates: {
      en: '📖 Read this text with {emotion} emotion',
      es: '📖 Lee este texto con emoción de {emotion}',
      fr: '📖 Lisez ce texte avec l\'émotion {emotion}',
      de: '📖 Lesen Sie diesen Text mit {emotion} Emotion',
      ja: '📖 このテキストを{emotion}の感情で読んでください',
      zh: '📖 用{emotion}情感朗读这段文字',
      ko: '📖 이 텍스트를 {emotion} 감정으로 읽어주세요'
    }
  },
