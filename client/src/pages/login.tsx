...
export default function Login() {
  ...
  const handleOAuthLogin = (provider: string) => {
    ...
    // Try popup first, then fallback to same-tab redirect
    ...
    if (!popup || popup.closed) {
      // Popup blocked or failed, use same-tab redirect
      console.log(`Popup blocked, using same-tab redirect for ${provider}`);
      setOauthLoading(null);
    ...
    setTimeout(() => {
      if (!popup.closed) {
        ...
        toast({
          title: "Login Timeout",
          description: "OAuth login took too long. Please try again.",
          variant: "destructive",
        });
      }
      clearInterval(checkClosed);
